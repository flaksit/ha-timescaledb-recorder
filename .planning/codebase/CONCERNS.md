...
- Files: `custom_components/timescaledb_recorder/__init__.py` line 71 (`ssl=False`)
...
- Files: `custom_components/timescaledb_recorder/__init__.py` line 61, `custom_components/timescaledb_recorder/config_flow.py` line 31
...
- Files: `custom_components/timescaledb_recorder/config_flow.py` line 35 (`except Exception:  # noqa: BLE001`)
...
- Files: `README.md` line 54, `custom_components/timescaledb_recorder/const.py` lines 11 and 15
...
- Files: `custom_components/timescaledb_recorder/ingester.py` line 65–66
...
- Files: `custom_components/timescaledb_recorder/syncer.py` line 63
...
- Files: `custom_components/timescaledb_recorder/config_flow.py` lines 59–60 and 68
...
- Files: `custom_components/timescaledb_recorder/__init__.py` lines 76–80, `custom_components/timescaledb_recorder/schema.py`
...
- Files: `custom_components/timescaledb_recorder/__init__.py` lines 64–72
...
- Files: `custom_components/timescaledb_recorder/syncer.py` lines 381, 425, 476, 520
...
- Files: `custom_components/timescaledb_recorder/syncer.py` lines 150–174
- Impact: If the schema was partially created (e.g. `entities` exists but `devices` does not), the snapshot will fail partway through, leaving an inconsistent dimension table state.
...
- Files: `custom_components/timescaledb_recorder/syncer.py` lines 160–174
...
- Files: `custom_components/timescaledb_recorder/syncer.py` lines 249–331
...
- Files: `custom_components/timescaledb_recorder/ingester.py` lines 85–89
...
- Files: `custom_components/timescaledb_recorder/syncer.py` lines 369–374, 416–418, 466–469, 509–512
...
- Files: `custom_components/timescaledb_recorder/__init__.py` lines 44–56, `custom_components/timescaledb_recorder/config_flow.py`
...
- Files: `custom_components/timescaledb_recorder/__init__.py` lines 59–100
...
- Files: `custom_components/timescaledb_recorder/__init__.py` lines 108–114
...
- Files: `custom_components/timescaledb_recorder/config_flow.py` lines 56–88, `tests/test_config_flow.py`
...
- Files: `custom_components/timescaledb_recorder/ingester.py`
...
- Problem: `async_setup_schema` is entirely additive and idempotent for new installs. There is no mechanism for ALTER TABLE migrations. If a future version needs to add a column to `states` or change a dim_* column type, it would require manual SQL or a schema version table.
- Files: `custom_components/timescaledb_recorder/schema.py`
...
- Files: `pyproject.toml` line 3, `custom_components/timescaledb_recorder/manifest.json` line 4
