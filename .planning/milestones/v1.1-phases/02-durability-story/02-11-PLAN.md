...
<task type="auto">
  ...
  <read_first>
    ...
    - custom_components/timescaledb_recorder/overflow_queue.py (entire file — asserting internal behaviour)
    - custom_components/timescaledb_recorder/retry.py (entire file)
  </read_first>
  <action>
...
<task type="auto">
  ...
  <files>tests/test_overflow_queue.py, tests/test_persistent_queue.py, tests/test_retry.py, tests/test_issues.py</files>
  <read_first>
    - custom_components/timescaledb_recorder/persistent_queue.py (entire file)
    - custom_components/timescaledb_recorder/issues.py (entire file)
